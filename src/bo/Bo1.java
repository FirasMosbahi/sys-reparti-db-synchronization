...
public class Bo1 extends JPanel {
    ...
    private BoService bo1Service = new BoService(1);

    /**
     * Create the panel.
     */
    public Bo1() throws SQLException {
        setLayout(null);
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    bo1Service.createDbRow(newProduct);
        ...
        btnGetList.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    initialProducts = bo1Service.getAllProducts();
                } catch (SQLException ex) {
                    throw new RuntimeException(ex);
                }
                model.setRowCount(0);
    ...
    public static void main(String [] args) throws SQLException {
        JFrame frame = new JFrame("Bo 1");
        frame.setContentPane(new Bo1());
