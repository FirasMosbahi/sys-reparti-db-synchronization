...
public class Ho extends JPanel {
    ...
    private HoService hoService = new HoService();
    ...
    public Ho() throws SQLException {
        ...
        ArrayList<Product> initialProducts = hoService.getAllProducts();
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                Product newProduct = new Product(i,Date,Product,Integer.parseInt(Qty),Double.parseDouble(cost),"ho");
                try {
                    hoService.createDbRow(newProduct);
        ...
        btnGetList.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    initialProducts = hoService.getAllProducts();
                } catch (SQLException ex) {
                    throw new RuntimeException(ex);
                }
